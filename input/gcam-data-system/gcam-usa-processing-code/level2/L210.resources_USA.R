...
L210.SmthRenewRsrcCurves_offshore_wind_USA$year.fillout <- min( model_years )
L210.SmthRenewRsrcCurves_offshore_wind_USA <- L210.SmthRenewRsrcCurves_offshore_wind_USA[, names_SmthRenewRsrcCurves]
