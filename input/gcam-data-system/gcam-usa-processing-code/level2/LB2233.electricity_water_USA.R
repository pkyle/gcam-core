...
#L2233.StubTech_WaterCoef_ref["technology"] <- elec_tech_water_map[match(paste(L2233.StubTech_WaterCoef_ref[,"fuel"],L2233.StubTech_WaterCoef_ref[,"plant_type"]),
#paste(elec_tech_water_map$fuel,elec_tech_water_map$plant_type)),"technology"]
...
#L2233.StubTech_WaterCoef_frozen["technology"] <- elec_tech_water_map[match(paste(L2233.StubTech_WaterCoef_frozen[,"fuel"],L2233.StubTech_WaterCoef_frozen[,"plant_type"]),
#paste(elec_tech_water_map$fuel,elec_tech_water_map$plant_type)),"technology"]
