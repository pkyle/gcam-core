...
USGS_gas_supply_Quad <- readdata( "GCAMUSA_LEVEL0_DATA", "USGS_gas_supply_Quad", skip = 3 )
...
EIA_gas_A_MMcf <- readdata( "GCAMUSA_LEVEL0_DATA", "EIA_gas_A_MMcf", skip = 3 )
EIA_gas_offshore_MMcf <- readdata( "GCAMUSA_LEVEL0_DATA", "EIA_gas_offshore_MMcf", skip = 2 )
EIA_gas_shale_MMcf <- readdata( "GCAMUSA_LEVEL0_DATA", "EIA_gas_shale_MMcf", skip = 2 )
EIA_gas_coalbed_MMcf <- readdata( "GCAMUSA_LEVEL0_DATA", "EIA_gas_coalbed_MMcf", skip = 2 )
EIA_gas_US_T_MMcf <- readdata( "GCAMUSA_LEVEL0_DATA", "EIA_gas_US_T_MMcf", skip = 2 )
