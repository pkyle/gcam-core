...
module_energy_L254.transportation_DECARB_low_elec <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    return(c(FILE = "common/GCAM_region_names",
             ...
             "L154.in_EJ_R_trn_m_sz_tech_F_Yh_low_elec",
             "L154.cost_usdvkm_R_trn_m_sz_tech_F_Y_low_elec",
             "L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_low_elec",
             "L154.loadfactor_R_trn_m_sz_tech_F_Y_low_elec",
             "L154.speed_kmhr_R_trn_m_sz_tech_F_Y_low_elec",
             "L154.out_mpkm_R_trn_nonmotor_Yh_low_elec"))
  } else if(command == driver.DECLARE_OUTPUTS) {
    return(c("L254.Supplysector_trn_low_elec",
             "L254.FinalEnergyKeyword_trn_low_elec",
             "L254.tranSubsectorLogit_low_elec",
             "L254.tranSubsectorShrwt_low_elec",
             "L254.tranSubsectorShrwtFllt_low_elec",
             "L254.tranSubsectorInterp_low_elec",
             "L254.tranSubsectorInterpTo_low_elec",
    ...
    L154.in_EJ_R_trn_m_sz_tech_F_Yh_low_elec <- get_data(all_data, "L154.in_EJ_R_trn_m_sz_tech_F_Yh_low_elec",strip_attributes = TRUE)
    L154.cost_usdvkm_R_trn_m_sz_tech_F_Y_low_elec <- get_data(all_data, "L154.cost_usdvkm_R_trn_m_sz_tech_F_Y_low_elec",strip_attributes = TRUE)
    L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_low_elec <- get_data(all_data, "L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_low_elec",strip_attributes = TRUE)
    L154.loadfactor_R_trn_m_sz_tech_F_Y_low_elec <- get_data(all_data, "L154.loadfactor_R_trn_m_sz_tech_F_Y_low_elec",strip_attributes = TRUE)
    L154.speed_kmhr_R_trn_m_sz_tech_F_Y_low_elec <- get_data(all_data, "L154.speed_kmhr_R_trn_m_sz_tech_F_Y_low_elec",strip_attributes = TRUE)
    L154.out_mpkm_R_trn_nonmotor_Yh_low_elec <- get_data(all_data, "L154.out_mpkm_R_trn_nonmotor_Yh_low_elec",strip_attributes = TRUE)
    ...
    # L154.loadfactor_R_trn_m_sz_tech_F_Y_low_elec reports load factors by GCAM region / mode / size class / technology / fuel / year
    #kbn 2019-10-14 Switching to left_join_keep_first, since we have fewer mode categories now.
    #kbn 2020-06-02 Adding sce below (See description of changes using search string kbn 2020-06-02 Making changes to generate xmls for SSPs flexibly)
    L154.loadfactor_R_trn_m_sz_tech_F_Y_low_elec %>%
      filter(year %in% MODEL_YEARS) %>%
    ...
    # L154.cost_usdvkm_R_trn_m_sz_tech_F_Y_low_elec reports non-fuel cost by GCAM region / mode / size class / technology / fuel / year "
    ##kbn 2019-10-14 Switching to left_join_keep_first, since we have fewer mode categories now.
    #kbn 2020-06-02 Updating with sce below (See description of changes using search string kbn 2020-06-02 Making changes to generate xmls for SSPs flexibly)
    L154.cost_usdvkm_R_trn_m_sz_tech_F_Y_low_elec %>%
      filter(year %in% MODEL_YEARS) %>%
    ...
    # L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_low_elec reports vehicle energy intensity by GCAM region / mode / size class / technology / fuel / year
    #kbn 2019-10-14 Switching to left_join_keep_first, since we have fewer mode categories now.
    L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_low_elec %>%
      filter(year %in% MODEL_YEARS) %>%
    ...
    # L154.out_mpkm_R_trn_nonmotor_Yh_low_elec reports service output by GCAM region / non-motorized transport mode / year
    L154.out_mpkm_R_trn_nonmotor_Yh_low_elec %>%
      mutate(sce= paste0("CORE")) %>%
      filter(year %in% MODEL_BASE_YEARS) %>%
    ...
    L254.Supplysector_trn %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions", "L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_low_elec",
                     "energy/A54.sector", "energy/A54.globaltech_nonmotor", "energy/A54.globaltech_passthru", "energy/A54.globaltech_passthru_revised") ->
      L254.Supplysector_trn_low_elec
    ...
    L254.tranSubsectorSpeed %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions", "L154.speed_kmhr_R_trn_m_sz_tech_F_Y_low_elec") ->
      L254.tranSubsectorSpeed_low_elec
    ...
    L254.tranSubsectorSpeed_passthru %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/A54.tranSubsector_VOTT", "energy/A54.tranSubsector_VOTT_revised",
                     "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions", "L154.speed_kmhr_R_trn_m_sz_tech_F_Y_low_elec") ->
      L254.tranSubsectorSpeed_passthru_low_elec
    ...
    L254.tranSubsectorVOTT %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/A54.tranSubsector_VOTT", "energy/A54.tranSubsector_VOTT_revised",
                     "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions", "L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_low_elec",
    ...
    L254.StubTranTechCalInput %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions", "L154.in_EJ_R_trn_m_sz_tech_F_Yh_low_elec") ->
      L254.StubTranTechCalInput_low_elec
    ...
    L254.StubTranTechLoadFactor %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions", "L154.loadfactor_R_trn_m_sz_tech_F_Y_low_elec") ->
      L254.StubTranTechLoadFactor_low_elec
    ...
    L254.StubTranTechCost %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions", "L154.cost_usdvkm_R_trn_m_sz_tech_F_Y_low_elec") ->
      L254.StubTranTechCost_low_elec
    ...
    L254.StubTechCalInput_passthru %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions",
                     "L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_low_elec", "energy/A54.globaltech_passthru", "energy/A54.globaltech_passthru_revised") ->
      L254.StubTechCalInput_passthru_low_elec
    ...
    L254.StubTechProd_nonmotor %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/A54.sector", "L154.out_mpkm_R_trn_nonmotor_Yh_low_elec") ->
      L254.StubTechProd_nonmotor_low_elec
    ...
    L254.BaseService_trn %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/A54.sector", "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions",
                     "L154.out_mpkm_R_trn_nonmotor_Yh_low_elec", "L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_low_elec",
                     "L154.loadfactor_R_trn_m_sz_tech_F_Y_low_elec", "L154.in_EJ_R_trn_m_sz_tech_F_Yh_low_elec") ->
      L254.BaseService_trn_low_elec

    return_data(L254.Supplysector_trn_low_elec, L254.FinalEnergyKeyword_trn_low_elec, L254.tranSubsectorLogit_low_elec,
                L254.tranSubsectorShrwt_low_elec, L254.tranSubsectorShrwtFllt_low_elec, L254.tranSubsectorInterp_low_elec,
                L254.tranSubsectorInterpTo_low_elec, L254.tranSubsectorSpeed_low_elec, L254.tranSubsectorSpeed_passthru_low_elec,
                L254.tranSubsectorSpeed_noVOTT_low_elec, L254.tranSubsectorSpeed_nonmotor_low_elec, L254.tranSubsectorVOTT_low_elec,
                L254.tranSubsectorFuelPref_low_elec, L254.StubTranTech_low_elec, L254.StubTech_passthru_low_elec, L254.StubTech_nonmotor_low_elec,
                L254.GlobalTechShrwt_passthru_low_elec, L254.GlobalTechShrwt_nonmotor_low_elec, L254.GlobalTechCoef_passthru_low_elec,
                L254.GlobalRenewTech_nonmotor_low_elec, L254.GlobalTranTechInterp_low_elec, L254.GlobalTranTechShrwt_low_elec,
                L254.GlobalTranTechSCurve_low_elec, L254.GlobalTranTechProfitShutdown_low_elec, L254.StubTranTechCalInput_low_elec, L254.StubTranTechLoadFactor_low_elec,
                L254.StubTranTechCost_low_elec, L254.StubTranTechCoef_low_elec, L254.StubTechCalInput_passthru_low_elec,
                L254.StubTechProd_nonmotor_low_elec, L254.PerCapitaBased_trn_low_elec, L254.PriceElasticity_trn_low_elec,
                L254.IncomeElasticity_trn_low_elec, L254.BaseService_trn_low_elec)
  } else {
