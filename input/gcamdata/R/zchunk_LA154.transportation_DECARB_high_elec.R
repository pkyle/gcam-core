...
#' @importFrom rlang :=
#' @author RH May 2017
module_energy_LA154.transportation_UCD_high_elec <- function(command, ...) {
  ...
  if(command == driver.DECLARE_INPUTS) {
    return(c(FILE = "common/iso_GCAM_regID",
             ...
             FILE = "energy/OTAQ_trn_data_DECARB_high_elec",
    ...
    return(c("L154.in_EJ_R_trn_m_sz_tech_F_Yh_high_elec",
             "L154.in_EJ_ctry_trn_m_sz_tech_F_high_elec",
             ...
             "L154.IEA_histfut_data_times_UCD_shares_high_elec",
             "UCD_trn_data_high_elec"))
    ...
    OTAQ_trn_data_DECARB_high_elec <- get_data(all_data, "energy/OTAQ_trn_data_DECARB_high_elec")
    ...
    OTAQ_trn_data_DECARB_high_elec %>%
      gather_years() %>%
      repeat_add_columns(tibble(sce = unique(UCD_trn_data$sce))) ->
      OTAQ_trn_data_DECARB_high_elec_to_bind
    ...
    OTAQ_trn_data_DECARB_high_elec_to_bind_noenergy <- filter(OTAQ_trn_data_DECARB_high_elec_to_bind, variable != "energy") %>%
    ...
    UCD_trn_data_nocalibration <- UCD_trn_data %>%
      ...
      anti_join(OTAQ_trn_data_DECARB_high_elec_to_bind_noenergy, by = c("sce", "UCD_region", "UCD_sector", "mode","size.class",
                                                    "UCD_technology", "UCD_fuel", "variable", "unit", "year")) %>%
      bind_rows(OTAQ_trn_data_DECARB_high_elec_to_bind_noenergy) %>%
      ...
      UCD_trn_data_calibrated <- filter(UCD_trn_data, variable %in% c("energy", "service output")
                                    & year == min(year)) %>%
        anti_join(filter(OTAQ_trn_data_DECARB_high_elec_to_bind, variable == "energy" & year == min(year)),
                  by = c("sce", "UCD_region", "UCD_sector", "mode","size.class",
                         "UCD_technology", "UCD_fuel", "variable", "unit", "year")) %>%
        bind_rows(filter(OTAQ_trn_data_DECARB_high_elec_to_bind, variable == "energy" & year == min(year)))
    ...
    IEA_histfut_data_times_UCD_shares %>%
      ...
      add_precursors("common/iso_GCAM_regID", "L101.in_EJ_ctry_trn_Fi_Yh",
                     ...
                     "energy/mappings/UCD_ctry", "energy/mappings/UCD_techs",
                     "energy/UCD_trn_data_SSP1","energy/UCD_trn_data_SSP3","energy/UCD_trn_data_SSP5","energy/UCD_trn_data_CORE",
                     "energy/mappings/UCD_size_class_revisions") ->L154.IEA_histfut_data_times_UCD_shares_high_elec
    ...
    UCD_trn_data %>%
      ...
      add_precursors("common/iso_GCAM_regID", "energy/mappings/UCD_ctry",
                     "energy/UCD_trn_data_CORE", "energy/OTAQ_trn_data_DECARB_high_elec",
                     "energy/mappings/UCD_size_class_revisions", "energy/mappings/UCD_size_class_revisions") ->
      UCD_trn_data_high_elec


    return_data(L154.in_EJ_R_trn_m_sz_tech_F_Yh_high_elec, L154.in_EJ_ctry_trn_m_sz_tech_F_high_elec,
                L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_high_elec, L154.loadfactor_R_trn_m_sz_tech_F_Y_high_elec,
                L154.cost_usdvkm_R_trn_m_sz_tech_F_Y_high_elec, L154.speed_kmhr_R_trn_m_sz_tech_F_Y_high_elec,
                L154.out_mpkm_R_trn_nonmotor_Yh_high_elec,L154.IEA_histfut_data_times_UCD_shares_high_elec,
                UCD_trn_data_high_elec)
  } else {
