...
module_energy_L254.transportation_DECARB_high_elec <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    return(c(FILE = "common/GCAM_region_names",
             ...
             "L154.in_EJ_R_trn_m_sz_tech_F_Yh_high_elec",
             "L154.cost_usdvkm_R_trn_m_sz_tech_F_Y_high_elec",
             "L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_high_elec",
             "L154.loadfactor_R_trn_m_sz_tech_F_Y_high_elec",
             "L154.speed_kmhr_R_trn_m_sz_tech_F_Y_high_elec",
             "L154.out_mpkm_R_trn_nonmotor_Yh_high_elec"))
  } else if(command == driver.DECLARE_OUTPUTS) {
    return(c("L254.Supplysector_trn_high_elec",
             "L254.FinalEnergyKeyword_trn_high_elec",
             "L254.tranSubsectorLogit_high_elec",
             "L254.tranSubsectorShrwt_high_elec",
             "L254.tranSubsectorShrwtFllt_high_elec",
             "L254.tranSubsectorInterp_high_elec",
             "L254.tranSubsectorInterpTo_high_elec",
    ...
    L154.in_EJ_R_trn_m_sz_tech_F_Yh_high_elec <- get_data(all_data, "L154.in_EJ_R_trn_m_sz_tech_F_Yh_high_elec",strip_attributes = TRUE)
    L154.cost_usdvkm_R_trn_m_sz_tech_F_Y_high_elec <- get_data(all_data, "L154.cost_usdvkm_R_trn_m_sz_tech_F_Y_high_elec",strip_attributes = TRUE)
    L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_high_elec <- get_data(all_data, "L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_high_elec",strip_attributes = TRUE)
    L154.loadfactor_R_trn_m_sz_tech_F_Y_high_elec <- get_data(all_data, "L154.loadfactor_R_trn_m_sz_tech_F_Y_high_elec",strip_attributes = TRUE)
    L154.speed_kmhr_R_trn_m_sz_tech_F_Y_high_elec <- get_data(all_data, "L154.speed_kmhr_R_trn_m_sz_tech_F_Y_high_elec",strip_attributes = TRUE)
    L154.out_mpkm_R_trn_nonmotor_Yh_high_elec <- get_data(all_data, "L154.out_mpkm_R_trn_nonmotor_Yh_high_elec",strip_attributes = TRUE)
    ...
    # L154.loadfactor_R_trn_m_sz_tech_F_Y_high_elec reports load factors by GCAM region / mode / size class / technology / fuel / year
    #kbn 2019-10-14 Switching to left_join_keep_first, since we have fewer mode categories now.
    #kbn 2020-06-02 Adding sce below (See description of changes using search string kbn 2020-06-02 Making changes to generate xmls for SSPs flexibly)
    L154.loadfactor_R_trn_m_sz_tech_F_Y_high_elec %>%
      filter(year %in% MODEL_YEARS) %>%
    ...
    # L154.cost_usdvkm_R_trn_m_sz_tech_F_Y_high_elec reports non-fuel cost by GCAM region / mode / size class / technology / fuel / year "
    ##kbn 2019-10-14 Switching to left_join_keep_first, since we have fewer mode categories now.
    #kbn 2020-06-02 Updating with sce below (See description of changes using search string kbn 2020-06-02 Making changes to generate xmls for SSPs flexibly)
    L154.cost_usdvkm_R_trn_m_sz_tech_F_Y_high_elec %>%
      filter(year %in% MODEL_YEARS) %>%
    ...
    # L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_high_elec reports vehicle energy intensity by GCAM region / mode / size class / technology / fuel / year
    #kbn 2019-10-14 Switching to left_join_keep_first, since we have fewer mode categories now.
    L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_high_elec %>%
      filter(year %in% MODEL_YEARS) %>%
    ...
    # L154.out_mpkm_R_trn_nonmotor_Yh_high_elec reports service output by GCAM region / non-motorized transport mode / year
    L154.out_mpkm_R_trn_nonmotor_Yh_high_elec %>%
      mutate(sce= paste0("CORE")) %>%
      filter(year %in% MODEL_BASE_YEARS) %>%
    ...
    L254.Supplysector_trn %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions", "L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_high_elec",
    ...
    L254.tranSubsectorSpeed %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions", "L154.speed_kmhr_R_trn_m_sz_tech_F_Y_high_elec") ->
      L254.tranSubsectorSpeed_high_elec
    ...
    L254.tranSubsectorSpeed_passthru %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/A54.tranSubsector_VOTT", "energy/A54.tranSubsector_VOTT_revised",
                     "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions", "L154.speed_kmhr_R_trn_m_sz_tech_F_Y_high_elec") ->
      L254.tranSubsectorSpeed_passthru_high_elec
    ...
    L254.tranSubsectorVOTT %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/A54.tranSubsector_VOTT", "energy/A54.tranSubsector_VOTT_revised",
                     "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions", "L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_high_elec",
    ...
    L254.StubTranTechCalInput %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions", "L154.in_EJ_R_trn_m_sz_tech_F_Yh_high_elec") ->
      L254.StubTranTechCalInput_high_elec
    ...
    L254.StubTranTechLoadFactor %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions", "L154.loadfactor_R_trn_m_sz_tech_F_Y_high_elec") ->
      L254.StubTranTechLoadFactor_high_elec
    ...
    L254.StubTranTechCost %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions", "L154.cost_usdvkm_R_trn_m_sz_tech_F_Y_high_elec") ->
      L254.StubTranTechCost_high_elec
    ...
    L254.StubTechCalInput_passthru %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions",
                     "L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_high_elec", "energy/A54.globaltech_passthru", "energy/A54.globaltech_passthru_revised") ->
      L254.StubTechCalInput_passthru_high_elec
    ...
    L254.StubTechProd_nonmotor %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/A54.sector", "L154.out_mpkm_R_trn_nonmotor_Yh_high_elec") ->
      L254.StubTechProd_nonmotor_high_elec
    ...
    L254.BaseService_trn %>%
      ...
      add_precursors("common/GCAM_region_names", "energy/A54.sector", "energy/mappings/UCD_techs", "energy/mappings/UCD_techs_revised", "energy/mappings/UCD_size_class_revisions",
                     "L154.out_mpkm_R_trn_nonmotor_Yh_high_elec", "L154.intensity_MJvkm_R_trn_m_sz_tech_F_Y_high_elec",
                     "L154.loadfactor_R_trn_m_sz_tech_F_Y_high_elec", "L154.in_EJ_R_trn_m_sz_tech_F_Yh_high_elec") ->
      L254.BaseService_trn_high_elec

    return_data(L254.Supplysector_trn_high_elec, L254.FinalEnergyKeyword_trn_high_elec, L254.tranSubsectorLogit_high_elec,
                L254.tranSubsectorShrwt_high_elec, L254.tranSubsectorShrwtFllt_high_elec, L254.tranSubsectorInterp_high_elec,
                L254.tranSubsectorInterpTo_high_elec, L254.tranSubsectorSpeed_high_elec, L254.tranSubsectorSpeed_passthru_high_elec,
                L254.tranSubsectorSpeed_noVOTT_high_elec, L254.tranSubsectorSpeed_nonmotor_high_elec, L254.tranSubsectorVOTT_high_elec,
                L254.tranSubsectorFuelPref_high_elec, L254.StubTranTech_high_elec, L254.StubTech_passthru_high_elec, L254.StubTech_nonmotor_high_elec,
                L254.GlobalTechShrwt_passthru_high_elec, L254.GlobalTechShrwt_nonmotor_high_elec, L254.GlobalTechCoef_passthru_high_elec,
                L254.GlobalRenewTech_nonmotor_high_elec, L254.GlobalTranTechInterp_high_elec, L254.GlobalTranTechShrwt_high_elec,
                L254.GlobalTranTechSCurve_high_elec, L254.GlobalTranTechProfitShutdown_high_elec, L254.StubTranTechCalInput_high_elec, L254.StubTranTechLoadFactor_high_elec,
                L254.StubTranTechCost_high_elec, L254.StubTranTechCoef_high_elec, L254.StubTechCalInput_passthru_high_elec,
                L254.StubTechProd_nonmotor_high_elec, L254.PerCapitaBased_trn_high_elec, L254.PriceElasticity_trn_high_elec,
                L254.IncomeElasticity_trn_high_elec, L254.BaseService_trn_high_elec)
  } else {
